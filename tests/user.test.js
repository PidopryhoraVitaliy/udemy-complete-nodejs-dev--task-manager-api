...
const { userOneId, userOne, tokenOne, setupDatabase } = require('./fixtures/db')
...
test('Should signup a new user', async () => {
    ...
    expect(user.password).not.toBe('newPass12345')
})
